...
### Парадокс контролируемого хаоса

За кажущейся спонтанностью стохастических фракталов скрывается ирония: чтобы создать убедительную "случайность", нужна невероятно точная математика. Чем естественнее выглядит результат — тем сложнее алгоритм за кулисами. 

Это как джаз: музыканты импровизируют, но только потому, что виртуозно владеют инструментом и знают гармонические правила. Так и здесь — свобода рождается из дисциплины, хаос из порядка, а бесконечное разнообразие из всего трёх строчек кода ветвления. 

Возможно, в этом и есть главное чудо — осознавать, что даже непредсказуемая красота подчиняется скрытой логике мироздания.
